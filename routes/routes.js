/*
//todo: also send stored cookies with http requests
//todo: generate and use accesTokens
//todo: change templates so they work with routes
const routes = {
    "GET /": "firstPageNoLog",
...
//todo: acces tokens must have an expiration time
...
const apiRoutesMapping = [
    ...
    [/^\/api\/logout\/?$/i, apiRoutesHandler.logout],
